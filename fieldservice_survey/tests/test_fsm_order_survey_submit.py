...
class TestFsmOrder(TransactionCase):
    ...
    # TODO: REVISAR SOBRE ERROS COMO
    # - <div style="margin:16px 0px 16px 0px">
    # + <div style="margin: 16px 0px 16px 0px;">

    # def test_compute_body(self):
    #     self.maxDiff = None
    #     self.survey_submit_wizard.template_id = self.template
    #     self.survey_submit_wizard._compute_body()
    #     expected_body = self.template.body_html
    #     self.assertEqual(self.survey_submit_wizard.body, expected_body)
    ...
    def test_send_mail(self):
        ...
        #     self.survey_submit_wizard.body,
        #     "survey.user_input",
        #     answer.ids,
        #     post_process=True,
        # )[answer.id]
        ...
        # Observação linha comentado por motivos
        # em que o test unitário cobra espaçamentos, ponto e virgula de estilizações.
        # self.assertEqual(mail.body_html, body)
